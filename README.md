[![GoDoc](https://godoc.org/github.com/RadicalApp/goquery?status.png)](https://godoc.org/github.com/kabuke/libsignal-protocol-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/kabuke/libsignal-protocol-go)](https://goreportcard.com/report/github.com/kabuke/libsignal-protocol-go)
...
- [API Reference](https://godoc.org/github.com/kabuke/libsignal-protocol-go)
...
Install the Signal library using the "go get" command:
    ...
    go get github.com/kabuke/libsignal-protocol-go/...
...
```go
import "github.com/kabuke/libsignal-protocol-go/serializer"
